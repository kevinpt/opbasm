...
For converting numeric string inputs to binary a pair of generator macros that can be used. First is ``use_ascii2bcd()`` which will convert a numeric ASCII string into BCD format.
