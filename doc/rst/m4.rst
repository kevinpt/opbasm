...
In addition, the & operator can be used to generate a :ref:`inst-test` instruction instead of :ref:`inst-compare`. The true block is executed if the test result is non-zero:
