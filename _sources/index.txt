...
Labels generated by macro expansions are all prefixed with "__". This prefix is ignored when tracking global labels so that structured programming macros can be invoked without unxpected changes in the behavior of local labels.
